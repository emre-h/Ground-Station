...
public class RocketSimulation extends JPanel implements GLEventListener, MouseMotionListener, OnNewDataReceived {
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        for (double i = 0; i < 0.1; i = i + 0.002) {
            glut.glutSolidCylinder(0.10 - i, 0.8 + i, 9, 100);
        }
